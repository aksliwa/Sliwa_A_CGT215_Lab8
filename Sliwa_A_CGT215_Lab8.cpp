// Sliwa_A_CGT215_Lab8.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    Texture cbowTex;
    LoadTex(cbowTex, "gameimages/crossbow.png");
    ...
    PhysicsSprite arrow;
    Texture arrowTex;
    LoadTex(arrowTex, "gameimages/arrow.png");
    ...
    //creating a boundary box into game
        ...
        Texture redTex;
        LoadTex(redTex, "gameimages/Duck.png");
        ...
        //import text
        Font fnt;
        if (!fnt.loadFromFile("gameimages/Ghastly Panic.ttf")) {
        ...
        //clearing window after game is over with completed parameters
            ...
            //world.VisualizeAllBounds(window);                                        why did professor green text this?
